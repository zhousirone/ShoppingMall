...
<head>
    ...
    <link href="/indexcss/style.css" type="text/css" rel="stylesheet">
            ...
            <ul id="sddm">
                <li style="padding-left:10px; background:url(images/wei.png) no-repeat left center; background-size:18px;"><a href="#" onmouseover="mopen('m1')" onmouseout="mclosetime()">关注我们</a></a>
                    <div id="m1" onmouseover="mcancelclosetime()" onmouseout="mclosetime()">
                        <img src="images/108430aeb.jpg" width="166" height="166">
                    </div>
                </li>
...
<div class="qing lok">
    <div class="juzhong">
        <div style="height:140px; background-color: #fff; box-shadow: 0 -12px 10px rgba(0,0,0,.2);width: 216px; float:left; position:absolute; top:0;">
            <div>
                <img src="images/jinyihe.png" style="height:140px; padding:0;margin: 0 auto;display: block;">
            </div>
        </div>
        <div class="rf">
            ...
            <div class="myk">
                ...
                <img src="images/ewm.jpg" width="80" style="float:right;">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="juzhong" style=" overflow:visible;">
        <div class="lf fenl">
            ...
            <div id="category-2015" onmouseover="this.className='on'" onmouseleave="this.className=''">
                <div class="ld">
                    <img src="images/flbg.png" width="21" height="15" class="lf">所有产品分类
                </div>
    ...
    <div class="qing bank" style="width:1200px; margin:0 auto; overflow:hidden; background:#fff;">
        <div class="kuai">
            <div class="J_user user">
                <div class="user_info user_info_level0 user_info_plusNaN" clstag="h|keycount|2016|09a">
                    <div class="J_user_info_avatar user_info_avatar">
                        <img class="J_user_info_avatar_img" src="images/no_login.jpg"><a class="user_info_avatar_lk" href="#" target="_blank"></a>
                    </div>
                    <div class="user_info_show">
                        ...
                        <p>
                            <a href="#" class="user_info_login">登录</a><a href="#" class="user_info_reg">注册</a>
                        </p>
                    </div>
                </div>
            ...
            <div class="kusi">
                ...
                <a href="#"><img src="images/bab1.png" width="38" height="35">会员</a>
                <a href="#"><img src="images/bab2.png" width="38" height="35">活动</a>
                <a href="#"><img src="images/bab5.png" width="38" height="35">网店</a>
                <a href="#"><img src="images/bab6.png" width="38" height="35">购物车</a>
                <a href="#"><img src="images/bab3.png" width="38" height="35">资讯</a>
                <a href="#"><img src="images/bab7.png" width="38" height="35">简介</a>
                <a href="#"><img src="images/bab4.png" width="38" height="35">留言</a>
                <a href="#"><img src="images/bab8.png" width="38" height="35">联系</a>
            </div>
        </div>
        <!--banner -->
            ...
            <div class="main_image" style="width:790px;margin-left: 225px;margin-top:8px;">
                <div id="slider-wrapper" class="index_post ption_r">
                    <div id="slider" class="nivoSlider">
                        ...
                        <a href="#" target="_blank">
                            <img src="images/banner5.jpg" alt=" "/></a>
                        <a href="#" target="_blank">
                            <img src="images/banner4.jpg" alt=" "/></a>
                    </div>
                </div>
...
<div class="qing tjk3">
    <div class="flf1 juzhong">
        <img src="images/bt2.jpg" width="100%" style="margin-bottom:10px;">
        <div class="juzhong">
            <div class="fllb">
                <div class="rxk">
