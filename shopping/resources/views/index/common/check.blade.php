    ...
    <div class="qing tibg">
        <div class="juzhong gwc-tk">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tbody><tr>
                    <td><img src="/web/images/pa1.png" width="273" height="19"></td>
                    <td><img src="/web/images/pa2.png" width="362" height="19"></td>
                    <td><img src="/web/images/pa30.png" width="615" height="19"></td>
                </tr>
                </tbody></table>
            <div class="qing chm">
        ...
        <div class="cenbg">
            <div class="qing">
                ...
                <div class="qing addk">
                    <div class="address_li add  addnn" id="div_address_id_41" onclick="change_address('41');">
                        <input type="radio" name="address_id" id="address_id_41" value="41" checked="" style="display:none;">
                    ...
                    <a href="my-address-add.php" class="add">
                        <div class=" add-tj"><img src="/web/images/dizhi_03.png" width="39" height="39">添加新地址</div>
                    </a>
                </div>
            </div>
            <!--支付方式 -->
            <div class="qing fuk">
                ...
                <div class="lf"><!--选中状态 class为paynn -->
                    ...
                    <a href="#" id="pay_method_1" class="pay paynn">
                        <img src="/web/images/pay1.png" width="160" height="60">
                    </a>
                    <a href="#" id="pay_method_2" class="pay"><img src="/web/images/pay2.png" width="160" height="60"></a>
                    <a href="#" id="pay_method_2" class="pay"><img src="/web/images/pay3.png" width="160" height="60"></a>
                </div>
            </div>
            <!--配送方式 -->
            <div class="qing dizk">
            ...
            <div class="qing">
                <div class="qing">
                    ...
                    <a href="shopCar" class="rf hui">返回购物车<span> &gt;</span></a>
                </div>
                <div class="qing xcp">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tbody><tr>
                            <td width="75"><img src="/web/images/484069aec.jpg" width="59" height="45"></td>
                            <td width=""><a href="product-view.php?id=1351" class="dj-m1">孙曰盛</a></td>
                            <td width="150" align="center"><div class="xsl">998元 ×1</div></td>
                            <td width="150" align="center"><div class="xslj">998元</div></td>
                        </tr>
                        </tbody></table>
                </div>
                <div class="qing fuyk0">
                    <div class="rf fuyk">
                        <div class="fu-you2 rf">1件</div>
                        <div class="fu-yu2 rf">商品件数：</div>
                    </div>
                    <div class="rf fuyk">
                        <div class="fu-you2 rf">998.00元</div>
                    ...
                    <div class="rf fuyk">
                        <div class="fu-you3 rf"><sapn>898.00元</sapn></div>
                        <div class="fu-yu2 fu-yu3 rf">应付总金额：</div>
                    </div>
                </div>
                <div class="qing rf"><a href="zhifu"><input type="button" value="确认并支付" class="jie2"></a></div>
            </div>
