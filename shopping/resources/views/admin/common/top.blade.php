...
<head>
    ...
    <!-- <link rel="stylesheet" href=".ad/admin/css/theme5.css"> -->
...
<div class="left-nav">
    <div id="side-nav">
        <ul id="nav">
            ...
            <li>
                <a href="javascript:;">
                    <i class="iconfont left-nav-li" lay-tips="商品管理属性">&#xe726;</i>
                    <cite>商品属性管理</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('管理列表','goods_add')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>管理列表</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('商品管理','attribute_class')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>商品管理</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('权限分类','goods_show')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>商品管理列表</cite></a>
                    </li>
                    <li>
