...
{{--                    <form class="layui-form layui-col-space5" action="attribute_clas">--}}
...
{{--                    </form>--}}
                    ...
                    <a class="layui-btn" title="修改" href="attribute_class">添加商品</a>
                    <a class="layui-btn" title="修改" href="goods_sku">选购商品</a>
                    <hr>
                ...
                <div class="layui-card-body ">
                    <table class="layui-table layui-form">
                        ...
                        <tr cate-id='1' fid='0' >
                            ...
                            @foreach($v['attr_goods'] as $key => $value)
                        <tr cate-id='2' fid='1' >
                            <td>
                                <input type="checkbox" name="" lay-skin="primary">
                            </td>
